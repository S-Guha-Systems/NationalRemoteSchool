...
const PrivacyPolicy = () => {
  return (
    <Box sx={{ p: { xs: 2, sm: 3 } }}>
      ...
      <List sx={{ listStyleType: "disc", pl: 3 }}>
        ...
        <ListItem sx={{ display: "list-item" }}>
          <Typography>
            ...
            this Agreement) refers to National Remote School, Siliguri.
          </Typography>
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
          <Typography>
        ...
        <ListItem sx={{ display: "list-item" }}>
          <Typography>
            <strong>Website</strong> refers to National Remote School,
            accessible from{" "}
            <Link
            ...
            >
              https://nationalremoteschool.sguhasystems.com
            </Link>
          </Typography>
        </ListItem>
        <ListItem sx={{ display: "list-item" }}>
      ...
      <List sx={{ listStyleType: "disc", pl: 3, color: "inherit" }}>
        <ListItem sx={{ display: "list-item" }}>
          <Typography>
            By email:{" "}
            <Link
        ...
        <ListItem sx={{ display: "list-item" }}>
          <Typography>
            ...
            <Link
              ...
              style={{ fontStyle: "italic" }}
            >
              https://nationalremoteschool.sguhasystems.com/contact
            </Link>
          </Typography>
        </ListItem>
      </List>
