  ...
  return (
    <Box>
      <LeftAlignedContentModel
        title="Privacy Policy"
        body="This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information
  when You use the Service and tells You about Your privacy rights and how the law protects You. We use Your Personal data to provide and improve the Service. By using
      ...
      <Box>
        ...
        <List
          sx={{
            listStyleType: "disc",
            pl: 3,
            "& .MuiListItem-root": { display: "list-item", pl: 1, py: 0.5 },
          }}
        >
          <ListItem>
            <Typography>
          ...
          <ListItem>
            <Typography>
              <strong>Application</strong> refers to National Remote School, the
          ...
          <ListItem>
            <Typography>
              ...
              in this Agreement) refers to National Remote School, Siliguri.
            </Typography>
          </ListItem>
        ...
        >
          <ListItem>
            <Typography>
              By email:{" "}
              <Link
                href="mailto:nationalremoteschool@gmail.com"
                underline="hover"
                fontStyle="italic"
              >
