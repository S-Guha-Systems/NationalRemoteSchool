...
export const metadata = {
  title: "Terms of Use",
  description:
    "Terms of Use for the National Remote School website and services.",
};
  ...
  return (
    <Box>
      <LeftAlignedContentModel
        title={"TERMS OF USE"}
        body={
          "By accessing and using National Remote School’s website and services, you agree to comply with and be bound by these Terms of Use. All content provided is for educational purposes only and must not be misused or reproduced without permission. Users are expected to engage responsibly, respect intellectual property, and follow all applicable laws. National Remote School reserves the right to update or modify these terms at any time, and continued use of the platform constitutes acceptance of any such changes."
        }
        imageUrl={terms}
      />
      {/* Agreement Section */}
      <Box className="terms">
        ...
        <Typography variant="body1">
          We are <strong>National Remote School</strong> ("Company," "we," "us,"
          "our"), a company registered in India at Siliguri, West Bengal.
        </Typography>
        <Typography variant="body1">
        ...
        <Typography variant="body1">
          ...
          completely free online education up to 12th class. We believe that
          every child deserves access to quality education, regardless of
          financial background or geographical barriers. Through innovative
          online tools and inclusive resources, we strive to make learning
          accessible to all.
        </Typography>
        <Typography variant="body1">
          You can contact us by email at{" "}
          <Link href="mailto:nationalremoteschool@gmail.com">
            nationalremoteschool@gmail.com&nbsp;
          </Link>
        </Typography>
        <Typography variant="body1">
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ("you"), and
          National Remote School, concerning your access to and use of the
        ...
        <List sx={{ pl: 3, mb: 3 }}>
          {[
            ...
            <ListItem key={idx} sx={{ fontWeight: "bold" }}>
              {idx + 1}. {item}
            </ListItem>
          ))}
        </List>
        ...
        {/* Body Sections */}
        <Box>
          {/* Example for section 1 - you can expand others similarly */}
          ...
          {/* --- Repeat similar structure for each numbered section --- */}
          <Typography variant="h5" sx={{ mt: 2, mb: 2 }} gutterBottom>
          ...
          {/* ...continue the rest of the sections (3–29) with same pattern... */}
          <Typography variant="body1">
          ...
          <Typography variant="body1">
            ...
            the&nbsp;
            <b>"PROHIBITED ACTIVITIES"</b> section below, we grant you a
            non-exclusive, non-transferable, revocable license to:
          </Typography>

          <Typography variant="body1">
            <strong> Access </strong> the Services;
            <br />
            <strong>Download or print a copy</strong> of any portion of the
            <br />
            Content to which you have properly gained access,
            <br />
            <strong>solely for your internal business purpose.</strong>
          </Typography>
          ...
          <Typography variant="body1">
            ...
            please address your request to: nationalremoteschool@gmail.com. If
          ...
          <Typography variant="body1">
            ...
            be viewable by other users of the Services. When you post
          ...
          <List sx={{ fontWeight: "bold" }}>
            <ListItem>A. VISA</ListItem>
            <ListItem>B. MASTER CARD</ListItem>
            <ListItem>C. RUPAY CARD</ListItem>
            <ListItem>D. PAYPAL</ListItem>
            <ListItem>E. AMERICAN EXPRESS</ListItem>
            <ListItem>F. DISCOVER</ListItem>
            <ListItem>G. UPI</ListItem>
            <ListItem>H. NET BANKING</ListItem>
          </List>
          ...
          <Typography variant="body1">
            ...
            be in <strong>INDIAN RUPEE ( INR )</strong>. You agree to pay all
            ...
            if we have already requested or received payment. We reserve the
            right to refuse any order placed through the Services. We may, in
          ...
          <List>
            ...
            <ListItem>
              B. Trick, defraud, or mislead us and other users, especially in
              any attempt to learn sensitive account information such as user
              passwords.
            </ListItem>
            <ListItem>
              C. Circumvent, disable, or otherwise interfere with
            ...
            <ListItem>
              D. Disparage, tarnish, or otherwise harm, in our opinion, us
              and/or the Services.
            </ListItem>
            <ListItem>
              E. Use any information obtained from the Services in order to
              harass, abuse, or harm another person.
            </ListItem>
            <ListItem>
              F. Make improper use of our support services or submit false
              reports of abuse or misconduct.
            </ListItem>
            <ListItem>
              G. Use the Services in a manner inconsistent with any applicable
              laws or regulations.
            </ListItem>
            {/* Continue Here */}
            <ListItem>
            ...
            <ListItem>
              I. Upload or transmit (or attempt to upload or to transmit)
            ...
            <ListItem>
              J. Engage in any automated use of the system, such as using
              scripts to send comments or messages, or using any data mining,
              robots, or similar data gathering and extraction tools.
            </ListItem>
            <ListItem>
              K. Delete the copyright or other proprietary rights notice from
              any Content.
            </ListItem>
            <ListItem>
              L. Attempt to impersonate another user or person or use the
              username of another user.
            </ListItem>
            <ListItem>
              M. Upload or transmit (or attempt to upload or to transmit) any
            ...
            <ListItem>
              N. Interfere with, disrupt, or create an undue burden on the
              Services or the networks or services connected to the Services.
            </ListItem>
            <ListItem>
              O. Harass, annoy, intimidate, or threaten any of our employees or
              agents engaged in providing any portion of the Services to you.
            </ListItem>
            <ListItem>
              P. Attempt to bypass any measures of the Services designed to
              prevent or restrict access to the Services, or any portion of the
              Services.
            </ListItem>
            <ListItem>
              Q. Copy or adapt the Services' software, including but not limited
              to Flash, PHP, HTML, JavaScript, or other code.
            </ListItem>
            <ListItem>
              R. Except as permitted by applicable law, decipher, decompile,
              disassemble, or reverse engineer any of the software comprising or
              in any way making up a part of the Services.
            </ListItem>
            <ListItem>
              S. Except as may be the result of standard search engine or
            ...
            <ListItem>
              T. Use a buying agent or purchasing agent to make purchases on the
              Services.
            </ListItem>
            <ListItem>
              U. Make any unauthorized use of the Services, including collecting
              usernames and/or email addresses of users by electronic or other
              means for the purpose of sending unsolicited email, or creating
              user accounts by automated means or under false pretenses.
            </ListItem>
            <ListItem>
              V. Use the Services as part of any effort to compete with us or
              otherwise use the Services and/or the Content for any
              revenue-generating endeavor or commercial enterprise.
            </ListItem>
            <ListItem>W. Sell or otherwise transfer your profile.</ListItem>
            <ListItem>
              X. Use the Services to advertise or offer to sell goods and
              services.
            </ListItem>
          </List>
          ...
          <Typography variant="body1">
            ...
            <br />
            <br />
            2. You have the written consent, release, and/or permission of each
            ...
            <br />
            <br />
            6. Your Contributions do not ridicule, mock, disparage, intimidate,
            or abuse anyone.
            <br />
            <br />
            ...
            <br />
            <br />
            8. Your Contributions do not violate the privacy or publicity rights
            of any third party.
            <br />
            <br />
            9. Your Contributions do not violate any applicable law concerning
            child pornography, or otherwise intended to protect the health or
            well-being of minors.
            <br />
            <br />
            10. Your Contributions do not include any offensive comments that
            are connected to race, national origin, gender, sexual preference,
            or physical handicap.
            <br />
            <br />
            11. Your Contributions do not otherwise violate, or link to material
          ...
          <Typography variant="body1">
            Copyright Office Of India Attn: Copyright Agent Controller General
            of Patents, Designs & Trade Marks (CGPDTM) Prof. (Dr) Unnat P.
            Pandit New Delhi, New Delhi 110078 India
          </Typography>
          ...
          <Typography variant="body1">
            ...
            laws of India. National Remote School and yourself irrevocably
          ...
          <Typography variant="body1">
            ...
            arbitrators shall be four (4). The seat, or legal place, or
            arbitration shall be New Delhi, India. The language of the
          ...
          <Typography variant="body1">
            <b>
              ...
              PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR 44000 INR. CERTAIN
          ...
          <Typography variant="h5" sx={{ mt: 2, mb: 2 }}>
            <strong>26. SMS TEXT MESSAGING</strong>
          </Typography>
          ...
          <Typography variant="body1">
            By opting into any TWILIO text messaging program, you expressly
            consent to receive text messages (SMS) to your mobile number. TWILIO
            text messages may include: account alerts, appointment reminders,
            responses to inquiries, special offers and order updates.
          </Typography>
          ...
          <Typography variant="body1">
            ...
            simply reply to the text with "<strong>STOP</strong>.” You may
          ...
          <Typography variant="body1">
            ...
            communications, please email us at nationalremoteschool@gmail.com.
          </Typography>
          ...
          <Typography variant="body1">
            ...
            at:{" "}
            <Link href="mailto:nationalremoteschool@gmail.com">
              <i>nationalremoteschool@gmail.com</i>
            </Link>
          </Typography>
        </Box>
      </Box>
